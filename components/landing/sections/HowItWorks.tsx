...
export function HowItWorks() {
  return (
    <section id="howitworks" className="bg-gray-50 box-border flex flex-col gap-10 md:gap-16 lg:gap-20 items-center left-0 overflow-clip px-4 sm:px-8 md:px-12 lg:px-12 xl:px-[120px] py-12 sm:py-16 md:py-20 lg:py-[112px] w-full">
      <div className="flex flex-col gap-10 md:gap-16 lg:gap-20 items-center max-w-[1280px] relative shrink-0 w-full">
        <div className="flex flex-col gap-4 md:gap-6 items-start leading-[0] relative shrink-0 text-center w-full px-4 sm:px-0">
          <h2 className="font-['Inter',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[0px] text-3xl sm:text-4xl tracking-[-0.96px] w-full max-w-full md:max-w-[768px] mx-auto whitespace-pre-wrap">
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap gap-6 md:gap-6 lg:gap-12 items-start justify-center relative shrink-0 w-full">
          {steps.map((step, index) => (
            <div key={index} className="box-border flex flex-col gap-6 md:gap-8 items-start w-full md:w-[calc(50%-12px)] lg:w-auto lg:flex-[1_0_0] overflow-clip p-4 md:p-5 relative shrink-0">
