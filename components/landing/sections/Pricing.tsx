...
export function Pricing() {
  return (
    <section className="bg-gray-50 box-border flex flex-col gap-[80px] items-center justify-center px-[120px] py-[112px] relative w-full">
      <div className="flex flex-col gap-[80px] items-center max-w-[1280px] relative shrink-0 w-full">
        <div className="box-border flex flex-col gap-6 items-center not-italic px-[373px] py-0 relative shrink-0 text-center w-full">
          <div className="font-['Inter',sans-serif] font-bold leading-[0] relative shrink-0 text-[0px] text-neutral-950 tracking-[-0.96px] whitespace-nowrap">
            <p className="leading-[normal] mb-0 text-[48px]">Simple, </p>
          ...
          <p className="font-['Arial',sans-serif] leading-[28px] min-w-full relative shrink-0 text-[18px] text-slate-600 w-[min-content] whitespace-pre-wrap">
            Choose the plan that fits your team size and project needs.
          </p>
        </div>
        <div className="flex flex-col gap-20 items-center relative shrink-0 w-full">
          <div className="bg-[#ececf0] box-border flex items-center p-1 relative rounded-[10px] shrink-0 w-[273px]">
            <div className="bg-blue-600 relative rounded-[8px] shrink-0">
            ...
            <button className="cursor-pointer flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] shrink-0">
              <div className="flex gap-[10px] items-center justify-center px-6 py-[6px] relative w-full">
          ...
          <div className="flex flex-wrap gap-6 items-start justify-center relative shrink-0 w-full">
            {plans.map((plan, index) => (
              <div
                key={index}
                className={`${plan.cardStyle || "bg-white"} ${plan.borderStyle} border-solid box-border flex flex-col h-[368px] items-center justify-center p-4 relative rounded-[11.424px] shrink-0 w-[280px]`}
              >
                  ...
                  <div className="flex flex-col gap-[19.585px] items-start relative w-full">
                    <div className="flex flex-col gap-[6.528px] items-start relative shrink-0 w-full">
                      <div className="flex items-start relative shrink-0 w-full">
                        <p className={`flex-[1_0_0] font-['Inter',sans-serif] font-normal leading-[26.113px] min-h-px min-w-px not-italic relative shrink-0 text-[20px] ${plan.textStyle || "text-neutral-950"} whitespace-pre-wrap`}>
                          {plan.name}
                        </p>
                      </div>
                      <div className="flex gap-[6.528px] items-end relative shrink-0 w-full">
                        <div className="flex gap-2 items-center justify-center relative shrink-0">
                          <p className={`font-['Arial',sans-serif] leading-[32.641px] not-italic relative shrink-0 text-[29.377px] ${plan.priceColor || plan.textStyle || "text-blue-600"}`}>
                            {plan.price}
                          </p>
                        </div>
                        {plan.period && (
                      ...
                      <p className={`font-['Inter',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[16px] ${plan.textStyle || "text-black"} tracking-[-0.32px] w-full whitespace-pre-wrap`}>
                        {plan.description}
                      </p>
                      ...
                      <div className="flex gap-2 items-center justify-center relative shrink-0 w-full">
                        <ul className={`block flex-[1_0_0] font-['Open_Sans',sans-serif] font-normal leading-[0] min-h-px min-w-px relative shrink-0 text-[13.056px] ${plan.textStyle || "text-[#717182]"} whitespace-pre-wrap`}>
                    ...
                    <Link
                      ...
                      className={`group ${plan.buttonStyle} box-border flex gap-2 h-[60px] items-center justify-center px-4 py-2 relative rounded-[54px] shrink-0 w-[246px]`}
                    >
                      <span className="font-['Inter',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[13.06px]">
                        {plan.buttonText}
                      </span>
                      <ArrowIcon 
