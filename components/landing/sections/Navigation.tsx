  ...
  return (
    <nav className="bg-gray-50 border-b-[1.25px] border-gray-100 border-l-0 border-r-0 border-solid border-t-0 box-border flex flex-col min-h-[65px] items-start pb-[1.25px] pt-0 px-4 md:px-8 lg:px-12 xl:px-[120px] sticky top-0 w-full z-50">
      <div className="flex min-h-[63.984px] items-center justify-between relative shrink-0 w-full">
        ...
        {/* Desktop Buttons */}
        <div className="hidden lg:flex flex-[1_0_0] h-[35.996px] min-h-px min-w-px relative shrink-0">
          <div className="flex gap-1 md:gap-1 lg:gap-2 xl:gap-4 h-[35.996px] items-center justify-end relative w-auto lg:w-full">
            <Link
              href="/login"
              className="group border border-blue-600 border-solid box-border flex gap-2 h-[35.996px] items-center justify-center px-4 py-[7px] relative rounded-[27px] shrink-0 transition-all duration-200 hover:bg-blue-50 hover:border-blue-700"
            >
              <div className="font-['Inter',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[11px] md:text-xs lg:text-sm text-blue-600 group-hover:text-blue-700 transition-colors">
                Sign in
              </div>
              <ArrowIcon className="relative shrink-0 text-blue-600 group-hover:text-blue-700 group-hover:translate-x-0.5 transition-all" size={14} />
            </Link>
            <Link
              href="/signup"
              className="group bg-blue-600 box-border flex gap-2 h-[35.996px] items-center justify-center px-4 py-[7px] relative rounded-[27px] shrink-0 transition-all duration-200 hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-600/25"
            >
              <div className="font-['Inter',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[11px] md:text-xs lg:text-sm text-white">
                Get Started
              </div>
              <ArrowIcon className="relative shrink-0 text-white group-hover:translate-x-0.5 transition-all" size={14} />
            </Link>
          </div>
        </div>
