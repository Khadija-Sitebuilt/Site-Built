...
export function Benefits() {
  ...
  return (
    <section
      id="benefits"
      className="box-border flex flex-col gap-12 md:gap-16 lg:gap-[80px] items-start justify-center px-4 sm:px-8 md:px-12 lg:px-12 xl:px-[120px] py-12 sm:py-16 md:py-20 lg:py-[112px] relative w-full"
      style={{
        background:
