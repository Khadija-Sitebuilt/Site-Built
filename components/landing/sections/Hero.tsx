    ...
    >
      <div className="flex flex-col gap-10 md:gap-16 lg:gap-20 items-center max-w-[1280px] relative shrink-0 w-full">
        <div className="flex flex-col gap-6 md:gap-8 items-center max-w-full md:max-w-[768px] relative shrink-0 w-full px-4 sm:px-0">
          <div className="flex flex-col gap-4 md:gap-6 items-center leading-[0] relative shrink-0 text-center w-full">
            ...
            >
              ...
              <p>generate accurate As-Builts automatically.</p>
            </div>
          </div>
          <div
        ...
        <div className="absolute left-[8%] lg:left-[10%] xl:left-[15%] 2xl:left-[205px] pointer-events-none rounded-full w-[80px] h-[80px] xl:w-[100px] xl:h-[100px] 2xl:w-[120px] 2xl:h-[120px] top-[140px] xl:top-[150px] 2xl:top-[159px] hidden lg:block">
          <img alt="" className="absolute inset-0 max-w-none object-cover rounded-full size-full" src={images.heroPlaceholder1} />
          <div className="absolute inset-0 shadow-[inset_0px_0px_4px_0px_rgba(11,64,182,0.2)]" />
        </div>
        <div className="absolute right-[8%] lg:right-[10%] xl:right-[15%] 2xl:left-[910px] rounded-full w-[80px] h-[80px] xl:w-[100px] xl:h-[100px] 2xl:w-[130px] 2xl:h-[130px] top-[150px] xl:top-[160px] 2xl:top-[171px] hidden lg:block">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-full size-full" src={images.heroPlaceholder2} />
        </div>
      </div>
    </section>
  );
