// Local image assets - Update paths after running download script
// To download images, run: node scripts/download-figma-images.js

// Option 1: Use local images (recommended for production)
export const images = {
  step1: "/images/landing/step1.png",
  step2: "/images/landing/step2.png",
  step3: "/images/landing/step3.png",
  heroPlaceholder: "/images/landing/heroPlaceholder.png",
  heroPlaceholder1: "/images/landing/heroPlaceholder1.png",
  heroPlaceholder2: "/images/landing/heroPlaceholder2.png",
  videoIcon: "/images/landing/videoIcon.png",
  arrowRight: "/images/landing/arrowRight.png",
  logoPart1: "/images/landing/logoPart1.png",
  logoPart2: "/images/landing/logoPart2.png",
  timeSquareIcon: "/images/landing/timeSquareIcon.png",
  shieldIcon: "/images/landing/shieldIcon.png",
  uploadIcon: "/images/landing/uploadIcon.png",
  soc2Icon: "/images/landing/soc2Icon.png",
  supportIcon: "/images/landing/supportIcon.png",
  uptimeIcon: "/images/landing/uptimeIcon.png",
  faqExpand: "/images/landing/faqExpand.png",
  faqCollapse: "/images/landing/faqCollapse.png",
  starIcon: "/images/landing/starIcon.png",
  avatarIcon: "/images/landing/avatarIcon.png",
  testimonialDivider: "/images/landing/testimonialDivider.png",
  arrowSmall1: "/images/landing/arrowSmall1.png",
  arrowSmall2: "/images/landing/arrowSmall2.png",
  arrowSmall3: "/images/landing/arrowSmall3.png",
  demoVideoIcon: "/images/landing/demoVideoIcon.png",
};

// Option 2: Fallback to Figma URLs (temporary - expires in 7 days)
// Uncomment below and comment above if you need to use Figma URLs temporarily
/*
export const images = {
